...
<body class="login-page">
    ...
    <script src="<?= base_url(); ?>./resources/AdminBSB/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="<?= base_url(); ?>./resources/AdminBSB/js/admin.js"></script>
    <script src="<?= base_url(); ?>./resources/AdminBSB/js/pages/examples/sign-in.js"></script>
</body>
